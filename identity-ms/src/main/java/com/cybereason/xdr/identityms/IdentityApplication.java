package com.cybereason.xdr.identityms;
...
public class IdentityApplication {
    ...
    private static final String SUB_TOPIC = "trans2idm";
    private static final String PUB_TOPIC = "idm2threat";
    private static final String PROJECT_NAME = "status-local";
    private static final String SUBSCRIBER_NAME = "identity-subscriber";
    ...
    public void messageReceiver(String payload) {
        ...
        messagingGateway.sendToPubsub(payload + ", identity");
