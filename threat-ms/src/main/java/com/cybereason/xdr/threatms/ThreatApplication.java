package com.cybereason.xdr.threatms;
...
public class ThreatApplication {
    private static final Logger LOGGER = LoggerFactory.getLogger(ThreatApplication.class);
    private static final String SUB_TOPIC = "idm2threat";
    private static final String PUB_TOPIC = "threat2router";
    private static final String PROJECT_NAME = "status-local";
    private static final String SUBSCRIBER_NAME = "threat-subscriber";
    ...
    public void messageReceiver(String payload) {
        ...
        messagingGateway.sendToPubsub(payload + ", threat");
